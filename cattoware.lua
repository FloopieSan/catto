if not isfolder('Floopie') then
    makefolder('Floopie')
    --writefile('/Floopie/Floopie.png',game:HttpGet('https://floopie.uk/needed/lib.png'))
end
...
library.theme = {
	...
	accentcolor = Color3.fromRGB(118, 0, 177),
	accentcolor2 = Color3.fromRGB(79, 0, 118),
...
function library:CreateWatermark(name, position)
    ...
    local OldTime = getCurrentTimeFormatted()
    ...
    function window:CreateTab(name)
        ...
        function tab:CreateSector(name,side)
            ...
            function sector:AddSlider(text, min, default, max, decimals, callback, flag)
                ...
                slider.InputLabel = Instance.new("TextLabel", slider.MainBack)
                slider.InputLabel.BackgroundTransparency = 1
